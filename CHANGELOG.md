...
- Publishes a versioned private raw `SKILL.md` URL at the `v0.1.16-dev` ref; authenticated collaborators can install from it, while anonymous public installation remains unclaimed.
...
This entry does not claim that Concierge is publicly installable or production-ready. It is a rough, semi-ready beta publication candidate for independent testing after the private GitHub upload gate.

...
def _record_matches_artifact(
    ...
    if _tree_files(artifact_root) != artifact.files:
        return False
...
def upgrade_artifact(
    ...
    *,
    ...
    if _tree_files(previous_artifact_root) != previous.artifact_files:
...
def uninstall_artifact(
    ...
    *,
    ...
    if (
        _tree_files(artifact_root) != installation.artifact_files
